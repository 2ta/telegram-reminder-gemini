...
from config.config import settings, MSG_HELP, MSG_WELCOME, MSG_ALREADY_PREMIUM, PAYMENT_AMOUNT, MSG_PAYMENT_BUTTON, MSG_PAYMENT_PROMPT, MSG_PAYMENT_ERROR, MSG_PAYMENT_SUCCESS, MSG_PAYMENT_FAILED, MSG_PAYMENT_CANCELLED, TELEGRAM_BOT_TOKEN, MSG_PROCESSING_VOICE, MSG_STT_FAILED, MSG_DATE_PARSE_ERROR, MSG_REMINDER_IN_PAST, MSG_REMINDER_NOT_FOUND_FOR_ACTION, MSG_GENERAL_ERROR, MSG_REQUEST_PRIMARY_EVENT_TIME, MSG_REQUEST_TASK, MSG_REQUEST_FULL_DATETIME, MSG_CONFIRM_DEFAULT_TIME, MSG_ASK_AM_PM, MSG_CONFIRMATION, MSG_NO_REMINDER_TO_EDIT, MSG_LIST_EMPTY, MSG_LIST_HEADER, MSG_LIST_ITEM, MSG_INVALID_SELECTION, MSG_SELECT_FOR_DELETE, MSG_REMINDER_DELETED, MSG_EDIT_REMINDER_FIELD_CHOICE, MSG_CONFIRMATION_UPDATE, MSG_CANCELLED, MSG_NLU_ERROR, MSG_REQUEST_TIME_ONLY, MSG_REMINDER_NOTIFICATION, MSG_SNOOZE_FAILURE_NLU, MSG_SNOOZE_CONFIRMATION, MSG_FAILURE_EXTRACTION
